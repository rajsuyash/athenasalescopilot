...
// Generated by apps/chrome-extension/scripts/package.mjs on every admin-web
// build, so the download always matches the extension source. Never hardcode
// the version here again (served 0.1.15 for four releases).
...
const EXT_VERSION = extensionMeta.version;
const ZIP_HREF = `/downloads/${extensionMeta.zipName}`;
const ZIP_SIZE_KB = extensionMeta.zipSizeKb;
const WEB_STORE_URL =
          ...
          <div className="aurora-border rounded-2xl">
            <div className="relative glass rounded-2xl p-6 h-full flex flex-col shadow-glow-mint">
              ...
              <p className="mt-2 text-center text-[11px] text-white/40">
                v{EXT_VERSION} · always the latest build
              </p>
            </div>
          </div>
        </div>
